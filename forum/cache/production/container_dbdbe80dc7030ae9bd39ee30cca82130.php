...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000001dcd1c9a000000016d314d69(
...
class phpbbtemplatetwiglexer_000000001dcd1c9a000000016d314d69 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder599db7be015c6267931592 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer599db7be015f8120327645 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties599db7be01545879636460 = array(
    ...
    {
        $this->initializer599db7be015f8120327645 && $this->initializer599db7be015f8120327645->__invoke($this->valueHolder599db7be015c6267931592, $this, 'set_environment', array('env' => $env), $this->initializer599db7be015f8120327645);

        return $this->valueHolder599db7be015c6267931592->set_environment($env);
    }
    ...
    {
        $this->initializer599db7be015f8120327645 && $this->initializer599db7be015f8120327645->__invoke($this->valueHolder599db7be015c6267931592, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer599db7be015f8120327645);

        return $this->valueHolder599db7be015c6267931592->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer599db7be015f8120327645 && $this->initializer599db7be015f8120327645->__invoke($this->valueHolder599db7be015c6267931592, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer599db7be015f8120327645);

        return $this->valueHolder599db7be015c6267931592->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer599db7be015f8120327645 = $initializer;
    }
    ...
    {
        $this->initializer599db7be015f8120327645 && $this->initializer599db7be015f8120327645->__invoke($this->valueHolder599db7be015c6267931592, $this, '__get', array('name' => $name), $this->initializer599db7be015f8120327645);

        if (isset(self::$publicProperties599db7be01545879636460[$name])) {
            return $this->valueHolder599db7be015c6267931592->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder599db7be015c6267931592;
    ...
    {
        $this->initializer599db7be015f8120327645 && $this->initializer599db7be015f8120327645->__invoke($this->valueHolder599db7be015c6267931592, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer599db7be015f8120327645);
    ...
    {
        $this->initializer599db7be015f8120327645 && $this->initializer599db7be015f8120327645->__invoke($this->valueHolder599db7be015c6267931592, $this, '__isset', array('name' => $name), $this->initializer599db7be015f8120327645);
    ...
    {
        $this->initializer599db7be015f8120327645 && $this->initializer599db7be015f8120327645->__invoke($this->valueHolder599db7be015c6267931592, $this, '__unset', array('name' => $name), $this->initializer599db7be015f8120327645);
    ...
    {
        $this->initializer599db7be015f8120327645 && $this->initializer599db7be015f8120327645->__invoke($this->valueHolder599db7be015c6267931592, $this, '__clone', array(), $this->initializer599db7be015f8120327645);

        $this->valueHolder599db7be015c6267931592 = clone $this->valueHolder599db7be015c6267931592;
    }

    public function __sleep()
    {
        $this->initializer599db7be015f8120327645 && $this->initializer599db7be015f8120327645->__invoke($this->valueHolder599db7be015c6267931592, $this, '__sleep', array(), $this->initializer599db7be015f8120327645);

        return array('valueHolder599db7be015c6267931592');
    }
    ...
    {
        return $this->initializer599db7be015f8120327645;
    }
    ...
    {
        return $this->initializer599db7be015f8120327645 && $this->initializer599db7be015f8120327645->__invoke($this->valueHolder599db7be015c6267931592, $this, 'initializeProxy', array(), $this->initializer599db7be015f8120327645);
    }
    ...
    {
        return null !== $this->valueHolder599db7be015c6267931592;
    }
    ...
    {
        return $this->valueHolder599db7be015c6267931592;
    }
